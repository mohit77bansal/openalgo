...
def _init_strategies():
    ...
    # ------------------------------------------------------------------
    # 21. Ultra-Selective Mean Reversion (targets Sharpe > 2, DD < 7%)
    ...
    # ------------------------------------------------------------------
    # 22. Weekly Momentum Filter (trades only 1-2x/week on strong signals)
    # ------------------------------------------------------------------
    ...
    # ------------------------------------------------------------------
    # 23. Tight Range Breakout (NR4 + volume, ultra-selective)
    # ------------------------------------------------------------------
    ...
    # --- Register new low-DD strategies ---
